...
string += f"Out of those, {bikes['global_stats']['bikes']['bikes']} are normal, {bikes['global_stats']['bikes']['electric_bikes']} are electic and {bikes['global_stats']['bikes']['electric_bikes_child_seat']} are electric with a child seat.{newl}"
...
string += f"Out of those, {bikes['global_stats']['stations']['full']} are full, {bikes['global_stats']['stations']['empty']} are empty, {bikes['global_stats']['stations']['probably_full']} might be full and {bikes['global_stats']['stations']['probably_empty']} might be emtpy.{newl}"
